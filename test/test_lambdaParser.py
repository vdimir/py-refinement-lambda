...
import pyrefine.ast_parser.lambda_parser as lambda_parser
...
class TestLambdaParser(unittest.TestCase):
    def test_parse_type_def_simple(self):
        prs = lambda_parser.LambdaParser()

        func_type = prs.parse_type_def_str('int -> bool -> int')
    ...
    def test_parse_type_def_func1(self):
        ...
        func_type = prs.parse_type_def_str('int -> (int -> int) -> int')
        self.assertIsInstance(func_type[0], model_types.IntVar)
    ...
    def test_parse_type_def_func2(self):
        ...
        func_type = prs.parse_type_def_str('(int -> int -> bool) -> bool -> int')
